...
public partial class CreateProfileDialog
{
    ...
    private static bool ValidateProfileName(string? profileName)
    {
        ...
        {
            Logger.Warn("Profile validation failed: name is empty");
        ...
        {
            Logger.Warn($"Profile validation failed: name too long ({profileName.Length} chars)");
            CustomMessageBox.Show(
        ...
        {
            Logger.Warn($"Profile validation failed: invalid characters in '{profileName}'");
            CustomMessageBox.Show(
